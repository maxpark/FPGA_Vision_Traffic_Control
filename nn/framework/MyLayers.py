...
import numpy as np
from MyUtils import show_hist, e
...
class MyInput(MyLayer):
    ...
    def __init__(self, input_image, name = 'input', dtype_str = 'float32'):
        ...
        self.input_image = self.np_out_data = self.keras_out_data = self.encode(input_image)
